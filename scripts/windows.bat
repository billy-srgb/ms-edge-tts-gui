...
%PY% -m PyInstaller --noconfirm --clean --onedir --windowed --name "EdgeTTSGui" --icon "assets\app.ico" --paths src --hidden-import docx --hidden-import pypdf --hidden-import certifi --collect-data certifi --collect-all customtkinter --collect-submodules edgettsgui src\edgettsgui\__main__.py
if not exist "dist\EdgeTTSGui\EdgeTTSGui.exe" exit /b 1

echo Building portable executable...
%PY% -m PyInstaller --noconfirm --clean --onefile --windowed --name "EdgeTTSGui-Portable" --icon "assets\app.ico" --paths src --hidden-import docx --hidden-import pypdf --hidden-import certifi --collect-data certifi --collect-all customtkinter --collect-submodules edgettsgui src\edgettsgui\__main__.py
